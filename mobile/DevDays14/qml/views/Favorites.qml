...
Utils.BaseTabBarPage {
    ...
    StateGroup {
        ...
        states: [
            State {
                name: "hasFavorites"
                when: _Model.favoritesModel.length > 0
                PropertyChanges {
                    target: _Loader
                    sourceComponent: _HasFavorites
                }
                PropertyChanges {
                    target: _Column
            ...
            Component {
                ...
                Item {
                    ...
                    ListView {
                        ...
                        property bool onlyShowFavorites : true
